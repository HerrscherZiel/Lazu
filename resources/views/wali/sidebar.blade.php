      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                <a href="/wali" class="nav-link {{ Request::segment(1) === 'wali' ? 'nav-link active' : null }}">
              ...
              <li class="nav-item">
              <a href="/profileWali" class="nav-link {{ Request::segment(1) === 'profileWali' ? 'nav-link active' : null }}">
